const Links = () => {
  return (
    <article className="grid grid-col-1 sm:grid-cols-2 gap-y-4 my-6">
      <div className="flex gap-2">
        ...
        <span className="text-[13px] text-desautaretedblue">Ghana</span>
      </div>
      <div className="flex gap-2">
        <span>
          <svg
        ...
        <span className="text-[13px] text-desautaretedblue">No Blog</span>
      </div>
      <div className="flex gap-2">
        <span>
          <svg
        ...
        <span className="text-[13px] text-desautaretedblue">Not available</span>
      </div>
      <div className="flex gap-2">
        <span>
          <svg
        ...
        <span className="text-[13px] text-desautaretedblue">
          Rotech Academy
        </span>
      </div>
    </article>
